...
public String toString() {
	return "Camion [patente=" + patente + ", fechaPatentamiento=" + fechaPatentamiento.get(Calendar.DATE)+"/"+(fechaPatentamiento.get(Calendar.MONTH)+1)+"/"+fechaPatentamiento.get(Calendar.YEAR) + ", cargaMaxima=" + cargaMaxima
			+ "] \n";
}
